...
|---|---|---|
| Convex | Installed and locked at **1.46.0**; manifest range is `^1.44.0` | [lockfile](../../package-lock.json), [manifest](../../package.json) |
| Google SDK | Installed and locked `@google/genai` **2.23.0** | [lockfile](../../package-lock.json) |
| React / Vite | Installed and locked React **19.3.0**, Vite **8.3.0** | [React lock](../../package-lock.json), [Vite lock](../../package-lock.json) |
| Current UI | Backend health screen; no participant builder or coding workspace yet | [App](../../src/App.tsx) |
| Current schema | Starter `numbers` table; no Episode entities yet | [schema](../../convex/schema.ts) |
| Gemini integration | Node internal action constructs `GoogleGenAI`, uses `gemini-3.8-flash`, and checks nonempty text | [Gemini action](../../convex/gemini.ts) |
| Environment contract | Typed `APP_ENV` and `GEMINI_API_KEY` already declared | [Convex config](../../convex/convex.config.ts) |

The generated Convex guidelines target `^1.44.0`; installed 1.46.0 satisfies that range. They require validated function arguments, internal functions for pipeline internals, bounded queries, and separate child tables for unbounded history. Their component guidance calls for Workpool when bounded async parallelism is needed. [Generated guidelines](../../convex/_generated/ai/guidelines.md), [function guidance](../../convex/_generated/ai/guidelines.md), [schema guidance](../../convex/_generated/ai/guidelines.md), [component guidance](../../convex/_generated/ai/guidelines.md).
